"""
Run beam-gas simulation with the Xsuite-BDSIM(Geant4) coupling via Xcoll.
=============================================
...
def run(config_file_path, config_dict):
    ...
    # Intialise particles for bem-gas Monte Carlo simulation
    ...
    # 🔹 Save beam-gas log
    # ===========================================
    save_beamgas_log(output_dir, bgman)
